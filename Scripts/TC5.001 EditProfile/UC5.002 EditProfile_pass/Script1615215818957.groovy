...
WebUI.setText(findTestObject('Object Repository/Page_Log in/input_Log in_u_email'), '614259047@webmail.npru.ac.th')
...
WebUI.navigateToUrl('http://localhost/projectalumni/index.php/Alumni/profile?id=3')

WebUI.click(findTestObject('Object Repository/Page_profile/div_                                       _b3fc7f'))

WebUI.setText(findTestObject('Object Repository/Page_profile/input__u_major'), 'สวัสดี')
...
WebUI.verifyTextPresent('ศรัณย์สุข', false)
